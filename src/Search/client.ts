...
const FLIGHT_INSPO_API = "https://test.api.amadeus.com/v1";
...
export const test_api = async (origin: string, one_way: boolean, nonstop: boolean, max_price?: number) => {
    ...
    const API_url = `${FLIGHT_INSPO_API}/shopping/flight-destinations?origin=${origin}&oneWay=${one_way_string}&nonStop=${nonstop_string}&maxPrice=${max_price ? max_price_string: "999999"}`
